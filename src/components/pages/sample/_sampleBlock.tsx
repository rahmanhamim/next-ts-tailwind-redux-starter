    ...
    <main className="container mb-96 mt-20">
      ...
      <div className="my-8 rounded-md border p-4 shadow">
        ...
        <div className="flex items-center flex-wrap space-x-4">
          <p className="w-32 p-2 flex items-center justify-center rounded-lg shadow-sm">
            primary:
          </p>
        ...
        <div className="mt-4 flex flex-wrap items-center space-x-4">
          ...
          <div className="h-16 w-16 border bg-content-50"></div>
          <div className="h-16 w-16 border bg-content-100"></div>
          <div className="h-16 w-16 bg-content-200"></div>
          <div className="h-16 w-16 bg-content-300"></div>
          <div className="h-16 w-16 bg-content-400"></div>
          <div className="h-16 w-16 bg-content-500"></div>
          <div className="h-16 w-16 bg-content-600"></div>
          <div className="h-16 w-16 bg-content-700"></div>
          <div className="h-16 w-16 bg-content-800"></div>
          <div className="h-16 w-16 bg-content-900"></div>
        </div>
      </div>
